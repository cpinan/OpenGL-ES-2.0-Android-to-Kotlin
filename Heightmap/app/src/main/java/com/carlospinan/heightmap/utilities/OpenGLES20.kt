package com.carlospinan.heightmap.utilities
...
object OpenGLES20 {
    ...
    fun gl2ActiveTexture(id: Int) {
        glActiveTexture(id)
    }

    fun gl2BindTexture(id: Int, textureId: Int) {
        glBindTexture(id, textureId)
    }

    fun gl2Uniform1i(location: Int, offset: Int = 0) {
